const Services = () => {
  return (
    <section id="services" className="  container mx-auto max-w-[88rem] w-full flex flex-col items-start justify-start gap-[150px]  px-5">
      <p
      ...
      <div className="grid-cols-12 grid   w-full  gap-5 md:gap-7 xl:gap-10 ">
        ...
        <div className="col-span-12 md:col-span-6    xl:col-span-4 py-6 px-6 flex flex-col items-start justify-center gap-7    bg-white bg-opacity-5 rounded-xl border-[1px] border-opacity-10 border-solid border-[#01FFD1] ">
          ...
          <p className="text-[20px] ">
            Designing intuitive interfaces that blend creativity and functionality, enhancing user engagement while reflecting your brand's unique personality.
          </p>
        </div>
      </div>
    </section>
