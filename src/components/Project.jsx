...
const projects = [
  {
    ...
    description:
      "A modern chat app built with React, Express, Socket.io, Tailwind CSS, and MongoDB, offering real- time messaging, a responsive design, and a seamless user experience. ",
  },

  {
    ...
    description:
      "  An e-commerce app built with Next.js, MongoDB, and Express, featuring secure payment integration, fast performance, and a smooth shopping experience for users. ",
  },
  {
  ...
  },
  {
    ...
    description:
      "An intuitive e-commerce dashboard built with TypeScript, React, and Chart.js, providing real - time analytics, user insights, and streamlined management for your online store. ",
  },
];
const Project = () => {
  return (
